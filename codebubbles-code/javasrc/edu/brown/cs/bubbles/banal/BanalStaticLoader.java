...
private class AsmAnnotationVisitor implements AnnotationVisitor {
...
private class AsmFieldVisitor implements FieldVisitor {
...
private class AsmMethodVisitor implements MethodVisitor {
   ...
   @Override public void visitMethodInsn(int op,String own,String nam,String desc) {
