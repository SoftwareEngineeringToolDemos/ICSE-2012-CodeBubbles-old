...
GradientPaint getGradientPaint(Dimension bsize, String indication)
{
   ...
   Color c = GRADIENT_BACKGROUND_COLOR[idx];

   return new GradientPaint(d[0], d[1], c, d[2], d[3],Color.WHITE);
}
...
private static Map<String,Boolean> known_packages = new HashMap<String,Boolean>();
