...
{
   return new ArrayList<BumpProblem>();
}
...
abstract int findLineNumber(int offset);
abstract int findLineOffset(int linenumber);

abstract int mapOffsetToEclipse(int offset);
abstract int mapOffsetToJava(int offset);
...
String getProjectName() 			{ return null; }
