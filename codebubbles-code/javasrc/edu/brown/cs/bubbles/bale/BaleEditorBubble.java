...
BaleEditorBubble(BaleFragmentEditor bfe)
{
   ...
   int maxwd = bp.getIntOption("Bale.initial.width",BALE_MAX_INITIAL_WIDTH);
   int maxht = bp.getIntOption("Bale.initial.height",BALE_MAX_INITIAL_HEIGHT);

   switch (bfe.getFragmentType()) {
      case NONE :
	 break;
      case METHOD :
	 maxwd = bp.getIntOption("Bale.initial.width.method",maxwd);
	 maxht = bp.getIntOption("Bale.initial.height.method",maxht);
	 break;
      case CLASS :
	 maxwd = bp.getIntOption("Bale.initial.width.class",maxwd);
	 maxht = bp.getIntOption("Bale.initial.height.class",maxht);
	 break;
      case FILE :
	 maxwd = bp.getIntOption("Bale.initial.width.file",maxwd);
	 maxht = bp.getIntOption("Bale.initial.height.file",maxht);
	 break;
      case FIELDS :
	 maxwd = bp.getIntOption("Bale.initial.width.fields",maxwd);
...
@Override public boolean connectTo(BudaBubble bb,MouseEvent evt)
{
   ...
   if ((evt.getModifiersEx() & (MouseEvent.CTRL_DOWN_MASK|MouseEvent.META_DOWN_MASK)) == 0) return false;
