...
void save()				{ base_document.save(); }
void revert()				{ base_document.revert(); }
void checkpoint()			{ base_document.checkpoint(); }

boolean canSave()			{ return base_document.canSave(); }
...
BaleRegion createDocumentRegion(int spos,int epos,boolean inceol)
		throws BadLocationException
{
...
BaleRegion getRegionFromEclipse(int soff,int eoff)
{
...
private BaleElementEvent setupOrphanElement()
{
   ...
   List<BaleElement> rl = new ArrayList<BaleElement>();
   rl.add(oe);
