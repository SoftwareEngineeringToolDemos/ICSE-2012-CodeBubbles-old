 ...
 **/
Color	BUSS_STACK_TOP_COLOR = Color.WHITE;


/**
 *	Color at the bottom of the bubble stack
 **/
Color	BUSS_STACK_BOTTOM_COLOR = new Color(0xc0c0ff);


/**
 *	Color for package labels in component
 **/
Color	BUSS_PACKAGE_LABEL_COLOR = Color.GRAY;


/**
 *	Color for class labels in components
 **/
Color	BUSS_CLASS_LABEL_COLOR = new Color(0xa020f0);
