...
public void setPythonNature(PybaseNature nature)
{
   this.the_nature = nature;
}
 ...
 */
public AbstractModule getRelativeModule(String name,PybaseNature nature)
{
   return super.getModule(false, name, nature, true); // cannot be a compiled module
}

public AbstractModule getModule(String name,PybaseNature nature,boolean checkSystemManager,
 ...
 */
public Tuple<AbstractModule, ModulesManager> getModuleAndRelatedModulesManager(String name,
...
public List<String> getCompletePythonPath(PybaseInterpreter interpreter,
