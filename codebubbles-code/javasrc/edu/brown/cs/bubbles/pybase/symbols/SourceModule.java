 ...
 * its tokens.
 */
public AbstractToken[] getWildImportedModules()
{
 ...
 */
public AbstractToken[] getTokenImportedModules()
{
 ...
 */
public AbstractToken[] getGlobalTokens()
{
	 ...
	 CompletionState state,String lookOnlyForNameStartingWith)
{
   ...
   try {
      ...
      GlobalModelVisitor globalModelVisitor = GlobalModelVisitor
...
public AbstractToken[] getGlobalTokens(CompletionState initialState,
...
{
   List<AbstractToken> modToks = GlobalModelVisitor.getTokens(ast,
 ...
 */
public Definition[] findDefinition(CompletionState state,int line,int col,
 ...
 * @param col: at 0
 */
public LocalScope getLocalScope(int line,int col)
{
   try {
      FindScopeVisitor scopeVisitor = getScopeVisitor(line, col);
