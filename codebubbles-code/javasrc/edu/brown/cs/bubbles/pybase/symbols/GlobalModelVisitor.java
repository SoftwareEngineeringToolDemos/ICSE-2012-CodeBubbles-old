	 ...
	 boolean onlyAllowTokensIn__all__,boolean lookingInLocalContext)
{
   ...
   token_set.add(new SourceToken(new Name("__dict__",Name.Load,false),"__dict__","","",
	    moduleName));
   if (moduleName != null && moduleName.endsWith("__init__")) {
      token_set.add(new SourceToken(new Name("__path__",Name.Load,false),"__path__","",
	       "",moduleName));
   }
   if (!lookingInLocalContext && visit_what.match(VisitorType.GLOBAL_TOKENS)) {
      // __file__ is always available for any module
      token_set.add(new SourceToken(new Name("__file__",Name.Load,false),"__file__","",
	       "",moduleName));
      token_set.add(new SourceToken(new Name("__name__",Name.Load,false),"__name__","",
	       "",moduleName));
   }
}
