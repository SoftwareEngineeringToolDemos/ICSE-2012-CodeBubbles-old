...
private static class LineBreakpoint extends PybaseDebugBreakpoint
{
   ...
   BreakType getType()			{ return BreakType.LINE; }
   ...
   protected void outputLocalBubbles(IvyXmlWriter xw) {
      xw.field("LINE",getLine());
      xw.field("FILE",file_data.getFile());
...
private static class ExceptionBreakpoint extends PybaseDebugBreakpoint
{
   ...
   BreakType getType()			{ return BreakType.EXCEPTION; }
   public String getException() 	{ return exception_name; }
   public boolean isCaught()		{ return is_caught; }
   public boolean isUncaught()		{ return is_uncaught; }
