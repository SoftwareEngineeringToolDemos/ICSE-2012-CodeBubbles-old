...
private void setupBubble()
{
   ...
   title_bar.setBackground(BDDT_STACK_BOTTOM_COLOR);
...
private class ValueTable extends SwingTreeTable implements BudaConstants.BudaBubbleOutputer
{
   ...
   @Override protected void paintComponent(Graphics g) {
	 ...
	 is_frozen = true;
      ...
      Color top = BDDT_STACK_TOP_COLOR;
      Color bot = BDDT_STACK_BOTTOM_COLOR;
      if (is_frozen) {
	 top = BDDT_STACK_FROZEN_TOP_COLOR;
	 bot = BDDT_STACK_FROZEN_BOTTOM_COLOR;
       }
      else if (is_extinct) {
	 top = BDDT_STACK_EXTINCT_TOP_COLOR;
	 bot = BDDT_STACK_EXTINCT_BOTTOM_COLOR;
       }
