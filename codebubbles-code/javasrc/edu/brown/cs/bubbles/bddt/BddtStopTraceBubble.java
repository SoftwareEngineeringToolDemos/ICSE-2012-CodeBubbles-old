...
private class RootNode implements TreeNode {
   ...
   @Override public Enumeration<?> children()		{ return Collections.enumeration(thread_nodes); }
...
private static class ThreadNode implements TreeNode {
   ...
   @Override public Enumeration<?> children()		{ return Collections.enumeration(stack_nodes); }
   @Override public boolean getAllowsChildren() 	{ return true; }
