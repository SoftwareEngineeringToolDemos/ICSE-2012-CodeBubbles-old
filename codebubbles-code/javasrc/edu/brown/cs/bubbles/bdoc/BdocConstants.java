 ...
 **/
Color CONTEXT_COLOR = new Color(128,0,134);
 ...
 **/
Color BDOC_TOP_COLOR = new Color(226,226,255);


/**
 *	Color at the bottom of the documentation panel.
 **/
Color BDOC_BOTTOM_COLOR = new Color(0x9080ff);
