...
private BvcrMain(String [] args)
{
   ...
   project_map = new HashMap<String,BvcrProject>();
   manager_map = new HashMap<String,BvcrVersionManager>();
   key_map = new HashMap<String,SecretKey>();
   id_map = new HashMap<String,String>();
   user_map = new HashMap<String,String>();
   diff_map = new HashMap<String,BvcrDifferenceSet>();
