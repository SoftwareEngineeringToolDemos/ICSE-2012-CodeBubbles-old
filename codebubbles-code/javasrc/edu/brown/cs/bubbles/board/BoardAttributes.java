...
static Color getColorByName(String v)
{
   ...
   try {
      ...
      BoardLog.logE("BOARD","bad color value: " + v);
    }
...
private AttributeSet setupSet(String id)
{
   ...
   for (String pnm : property_set.stringPropertyNames()) {
	 ...
	 Object aval = v;
	 if (typ != null) aval = convertType(typ,v);
...
private Object convertType(Object typ,String v)
{
