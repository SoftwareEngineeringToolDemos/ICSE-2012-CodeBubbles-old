 ...
 **/
//Color NOTE_TOP_COLOR = new Color(0xfefdd1);
String NOTE_TOP_COLOR="Beam.note.top.color";

/**
 *	Color at the bottom of a note bubble
 **/
//Color NOTE_BOTTOM_COLOR = new Color(0xf8ed5d);
String NOTE_BOTTOM_COLOR="Beam.note.bottom.color";


/**
 *	Color of a note bubble in the overview panel
 **/
Color NOTE_OVERVIEW_COLOR = new Color(0xf8ed5d);
 ...
 **/
//Color PROBLEM_TOP_COLOR = new Color(0xffffcccc,true);
String PROBLEM_TOP_COLOR="Beam.problem.top.color";

/**
 *	Color at the bottom of a problem (error/warning) bubble.
 **/
//Color PROBLEM_BOTTOM_COLOR = new Color(0xffffa0a0,true);
String PROBLEM_BOTTOM_COLOR="Beam.problem.bottom.color";

/**
 *	Color to use in the overview area for a problem bubble.
 **/
Color PROBLEM_OVERVIEW_COLOR = new Color(0xffffa0a0,true);


/**
 *	Color for displaying error messages in a problem bubble.
 **/
Color PROBLEM_ERROR_COLOR = Color.RED;


/**
 *	Color for displaying warning messages in a problem bubble.
 **/
Color PROBLEM_WARNING_COLOR = Color.BLACK;


/**
 *	Color for displaying notice messages (e.g. TODOs) in a problem/task bubble
 **/
Color PROBLEM_NOTICE_COLOR = new Color(0xff056005,true);
 ...
 **/
Color TASK_TOP_COLOR = new Color(0xfffffbd8,true);


/**
 *	Color at the bottom of a task bubble.
 **/
Color TASK_BOTTOM_COLOR = new Color(0xfffff890,true);


/**
 *	Color of a task bubble in the overview area.
 **/
Color TASK_OVERVIEW_COLOR = new Color(0xfffff890,true);
