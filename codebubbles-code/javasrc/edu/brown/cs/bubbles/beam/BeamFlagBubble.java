...
BeamFlagBubble(String imagePath)
{
   ...
   _Panel.setBackground(transparent);
   _Panel.setBorder(null);
   _FlagLabel.setBorder(null);

   setBorderColor(transparent, transparent);
   ...
   _ChevronLabel.setLocation(128 - 17, 128 - 17);
...
private class FlagMouseEvents extends MouseAdapter
{
   ...
   @Override public void mouseExited(MouseEvent arg0) {
      if ((0 <= arg0.getX()) && (arg0.getX() < 128) && (0 <= arg0.getY()) && (arg0.getY() < 128)) { }
      else {
	 _ChevronLabel.setVisible(false);
	 repaint();
       }
