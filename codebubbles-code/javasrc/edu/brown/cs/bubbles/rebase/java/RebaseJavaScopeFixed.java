...
synchronized void defineVar(RebaseJavaSymbol s)
{
...
synchronized RebaseJavaSymbol lookupVariable(String nm)
{
...
synchronized Collection<RebaseJavaSymbol> getDefinedFields()
{
...
synchronized void defineMethod(RebaseJavaSymbol js)
{
...
synchronized RebaseJavaSymbol lookupMethod(String id,RebaseJavaType aty)
{
...
synchronized Collection<RebaseJavaSymbol> getDefinedMethods()
{
   Collection<RebaseJavaSymbol> rslt = new ArrayList<RebaseJavaSymbol>();
