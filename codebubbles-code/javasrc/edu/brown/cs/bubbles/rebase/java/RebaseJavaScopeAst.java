...
void defineVar(RebaseJavaSymbol js)		      { lookup_scope.defineVar(js,this); }
RebaseJavaSymbol lookupVariable(String nm)	      { return lookup_scope.lookupVariable(nm,this); }

Collection<RebaseJavaSymbol> getDefinedFields()
{
   return lookup_scope.getDefinedFields(this);
}

void defineMethod(RebaseJavaSymbol js)		      { lookup_scope.defineMethod(js,this); }
RebaseJavaSymbol lookupMethod(String id,RebaseJavaType aty) { return lookup_scope.lookupMethod(id,aty,this); }

Collection<RebaseJavaSymbol> getDefinedMethods()
{
