...
private static class PrimType extends RebaseJavaType {
   ...
   boolean isPrimitiveType()			{ return true; }
   boolean isBooleanType()			{ return type_code == PrimitiveType.BOOLEAN; }
   boolean isNumericType() {
      if (type_code == PrimitiveType.BOOLEAN) return false;
      if (type_code == PrimitiveType.VOID) return false;
      return true;
    }
   boolean isVoidType() 			{ return type_code == PrimitiveType.VOID; }
   boolean isBaseKnown()			{ return true; }
   RebaseJavaType getKnownType(RebaseJavaTyper t)	    { return this; }
   RebaseJavaType getBaseType() 		{ return object_type; }
...
private static class ArrayType extends RebaseJavaType {
   ...
   boolean isArrayType()		{ return true; }
   RebaseJavaType getBaseType() 	      { return base_type; }
   RebaseJavaType getKnownType(RebaseJavaTyper typer) {
      RebaseJavaType bt = base_type.getKnownType(typer);
      if (bt == base_type) return this;
      return typer.findArrayType(bt);
    }

   boolean isBaseKnown()		{ return base_type.isBaseKnown(); }
...
private static abstract class ClassInterfaceType extends RebaseJavaType {
   ...
   void setSuperType(RebaseJavaType t) {
      if (t != this) super_type = t;
   }

   void setOuterType(RebaseJavaType t)		{ outer_type = t; }

   void addInterface(RebaseJavaType t) {
      if (t == null) return;
   ...
   Collection<RebaseJavaType> getInterfaces()	{ return interface_types; }

   boolean isClassType()			{ return true; }

   boolean isBaseKnown()			{ return isKnownType(); }

   RebaseJavaType getSuperType()		{ return super_type; }
   ...
   boolean isContextType()			{ return is_context; }
   void setContextType(boolean fg)		{ is_context = fg; }
...
private static abstract class KnownClassInterfaceType extends ClassInterfaceType {
   ...
   RebaseJavaType getKnownType(RebaseJavaTyper typer)	    { return this; }
   boolean isKnownType()			{ return true; }
...
private static class UnknownInterfaceType extends UnknownClassInterfaceType {
   ...
   boolean isInterfaceType()		{ return true; }
...
private static class EnumType extends UnknownClassInterfaceType {
   ...
   boolean isEnumType() 		{ return true; }
...
private static class ParamType extends RebaseJavaType {
   ...
   boolean isParameterizedType()		{ return true; }
   RebaseJavaType getBaseType() 		      { return base_type; }
   boolean isBaseKnown()			{ return base_type.isBaseKnown(); }
   boolean isAbstract() 			{ return base_type.isAbstract(); }

   List<RebaseJavaType> getComponents() 	      { return type_params; }
...
private static class VarType extends RebaseJavaType {
   ...
   boolean isTypeVariable()			{ return true; }
   boolean isClassType()			{ return true; }
   boolean isBaseKnown()			{ return true; }
...
private static class MethodType extends RebaseJavaType {
   ...
   boolean isMethodType()			{ return true; }
   RebaseJavaType getBaseType() 		      { return return_type; }

   List<RebaseJavaType> getComponents() 	      { return param_types; }
   ...
   Type createAstNode(AST ast)			{ return null; }
...
private static class ErrorType extends RebaseJavaType {
   ...
   boolean isErrorType()			{ return true; }
   boolean isBaseKnown()			{ return true; }
