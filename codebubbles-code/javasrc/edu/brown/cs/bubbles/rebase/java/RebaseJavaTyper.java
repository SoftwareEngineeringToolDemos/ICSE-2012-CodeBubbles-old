...
private class TypeFinder extends ASTVisitor {
   ...
   public boolean visit(PackageDeclaration t) {
   ...
   public boolean visit(ImportDeclaration t) {
   ...
   public boolean visit(EnumDeclaration t) {
      String nm = t.getName().getIdentifier();
      if (type_prefix != null) nm = type_prefix + "." + nm;
      addSpecificType(nm);
      type_prefix = nm;
   ...
   public void endVisit(EnumDeclaration t) {
      int idx = type_prefix.lastIndexOf('.');
      if (idx < 0) type_prefix = null;
      else type_prefix = type_prefix.substring(0,idx);
    }

   public boolean visit(AnonymousClassDeclaration t) {
   ...
   public void endVisit(AnonymousClassDeclaration t) {
      int idx = type_prefix.lastIndexOf('.');
      if (idx < 0) type_prefix = null;
      else type_prefix = type_prefix.substring(0,idx);
    }
...
private class TypeSetter extends ASTVisitor {
   ...
   public void endVisit(ArrayType t) {
   ...
   public void endVisit(QualifiedType t) {
   ...
   public void endVisit(WildcardType t) {
      setJavaType(t,type_map.get("?"));
    }

   public boolean visit(QualifiedName t) {
   ...
   public void endVisit(SimpleName t) {
      String s = t.getFullyQualifiedName();
      RebaseJavaType jt = lookupPossibleType(s);
      if (jt != null) setJavaType(t,jt);
    }
   ...
   public boolean visit(FieldDeclaration t) {
      canbe_type = true;
      visitItem(t.getType());
      canbe_type = false;
   ...
   public boolean visit(VariableDeclarationStatement t) {
      canbe_type = true;
      visitItem(t.getType());
      canbe_type = false;
      visitList(t.fragments());
   ...
   public boolean visit(VariableDeclarationExpression t) {
      canbe_type = true;
      visitItem(t.getType());
      canbe_type = false;
      visitList(t.fragments());
   ...
   public boolean visit(SingleVariableDeclaration t) {
      canbe_type = true;
      visitItem(t.getType());
      canbe_type = false;
      visitItem(t.getName());
   ...
   public boolean visit(CastExpression t) {
      canbe_type = true;
      visitItem(t.getType());
      canbe_type = false;
   ...
   public boolean visit(ClassInstanceCreation t) {
      canbe_type = true;
      visitItem(t.getType());
      visitList(t.typeArguments());
      canbe_type = false;
   ...
   public boolean visit(FieldAccess t) {
      canbe_type = true;
      visitItem(t.getExpression());
      canbe_type = false;
      visitItem(t.getName());
   ...
   public boolean visit(InstanceofExpression t) {
   ...
   public boolean visit(MethodInvocation t) {
      canbe_type = true;
      visitItem(t.getExpression());
      visitList(t.typeArguments());
      canbe_type = false;
   ...
   public boolean visit(SuperFieldAccess t) {
      canbe_type = true;
      visitItem(t.getQualifier());
      canbe_type = false;
      visitItem(t.getName());
   ...
   public boolean visit(SuperMethodInvocation t) {
      canbe_type = true;
      visitItem(t.getQualifier());
      visitList(t.typeArguments());
      canbe_type = false;
   ...
   public boolean visit(ThisExpression t) {
      canbe_type = true;
      visitItem(t.getQualifier());
      canbe_type = false;
      return false;
   ...
   public boolean visit(TypeLiteral t) {
      canbe_type = true;
      visitItem(t.getType());
      canbe_type = false;
      return false;
