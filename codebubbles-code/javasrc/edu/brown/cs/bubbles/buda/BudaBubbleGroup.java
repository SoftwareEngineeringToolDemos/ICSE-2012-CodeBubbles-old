...
BudaBubbleGroup()
{
   ...
   right_color = null;
   label_color = null;
   single_left_color = GROUP_SINGLE_LEFT_COLOR;
   single_right_color = GROUP_SINGLE_RIGHT_COLOR;
...
{
   Color c0 = BudaRoot.getPaleColor(c);
   setColor(c0,c);
}
...
void setColor(Color lc,Color rc)
{
   left_color = lc;
   right_color = rc;
   label_color = BudaRoot.getPaleColor(right_color,0.625);
}
