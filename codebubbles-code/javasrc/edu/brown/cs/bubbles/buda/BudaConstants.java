 ...
 **/
int BUBBLE_OVERVIEW_HEIGHT = 75;		// height of the overview bar
 ...
 */
Color OVERVIEW_NONSTYLIZED_VIEW_BORDER_COLOR = new Color(0,0,0,190);

/**
 *	Color for the border of bubbles displayed in the overview area when using stylized viewport.
 **/
Color OVERVIEW_STYLIZED_VIEW_BORDER_COLOR = new Color(100,149,237,190); // border color for bubbles in the overview
 ...
 **/
Color OVERVIEW_FAKE_TOP_COLOR = new Color(201,201,201,100);

/**
 *	Bottom color for the fake working set in the panning bar
 **/
Color OVERVIEW_FAKE_BOTTOM_COLOR = new Color(255,255,255,100);

/**
 *	Text color for the fake working set in the panning bar
 **/
Color OVERVIEW_FAKE_TEXT_COLOR = Color.WHITE;
 ...
 **/
Color BUTTON_PANEL_TOP_COLOR = new Color(0xfffcebe2);

/**
 *	Color (bottom) for the button panel.
 **/
Color BUTTON_PANEL_BOTTOM_COLOR = new Color(0xfffad4c2);

/**
 *	Color (top) for the top bar.
 **/
Color TOP_BAR_TOP_COLOR = new Color(0xffa7cde9);

/**
 *	Color (bottom) for the top bar.
 **/
Color TOP_BAR_BOTTOM_COLOR = new Color(0xffbbd8ee);
...
/**
 *	Color to overlay new bubbles with
 **/
Color NEW_COLOR = new Color(0x80ffc000,true);
 ...
 **/
Color GROUP_SINGLE_LEFT_COLOR = new Color(0x50ffffff,true);	// left color for singleton groups


/**
 *	Color on the right of a singleton group
 **/
Color GROUP_SINGLE_RIGHT_COLOR = new Color(0x30ffffff,true);	// right color for singletons
...
/**
 *	Default border color for a non-focused bubble.
 **/
Color	BUBBLE_BORDER_COLOR = Color.BLUE;	// normal bubble border color


/**
 *	Default border color for a focused bubble.
 **/
Color	BUBBLE_FOCUS_COLOR = Color.ORANGE;	// bubble border color when it has the focus
 ...
 **/
Color	BUBBLE_TOOLTIP_COLOR = new Color(255,255,192);
...
Color BUDA_MENU_BAR_BORDER_TOP_COLOR = new Color(0,0,0,10);
Color BUDA_MENU_BAR_BORDER_BOTTOM_COLOR = new Color(255,255,255,10);

/**
 *	Color for the menu
 **/
Color	BUDA_MENU_COLOR = new Color(0,0,0,0);


/**
 *	Background color for the menu
 **/
Color	BUDA_MENU_BACKGROUND_COLOR = Color.WHITE;
 ...
 **/
Color	LINK_COLOR = Color.BLACK;		// color of a normal link


/**
 *	Color of a normal link between bubbles when the target has the focus (transitively).
 **/
Color	LINK_FOCUS_COLOR = new Color(191, 0, 255);		// color of a link to a focused bubble


/**
 *	Color for user-drawn links.
 **/
Color	LINK_DRAW_COLOR = Color.ORANGE; 	// color for user-drawn links
 ...
 **/
   public File getDescription() throws IOException;
