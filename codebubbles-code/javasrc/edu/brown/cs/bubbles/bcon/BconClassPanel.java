...
private static Color   CLASS_COLOR = new Color(0x00c0c0);
private static Color   METHOD_COLOR = Color.BLUE;
private static Color   FIELD_COLOR = Color.MAGENTA;
private static Color   INITIALIZER_COLOR = Color.ORANGE;
private static Color   COMMENT_COLOR = new Color(0x3f7f5f);
...
@Override public void handlePopupMenu(MouseEvent e)
{
   ...
   // TODO: Make this an action so it does something
...
private class ClassListModel extends AbstractListModel<BconRegion> {
   ...
   private ClassListModel() {
      use_regions = new ArrayList<BconRegion>();
      cur_size = 0;
      is_valid = false;
    }
