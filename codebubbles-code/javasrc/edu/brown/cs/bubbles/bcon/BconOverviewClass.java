...
private static Color   NOTEXISTS_COLOR = new Color(0x80cccccc,true);
private static Color   CODE_COLOR = new Color(0,0,255,128);
private static Color   COMMENT_COLOR = new Color(0x803f7f5f,true);
...
Collection<BconRegion> findRegions(BudaConstants.BudaContentNameType typ,String name)
{
   ...
   Collection<BconRegion> rslt = new ArrayList<BconRegion>();
...
private void setupLines()
{
   ...
   line_set = new ArrayList<BconLine>();
...
void paint(Graphics2D g,double x0,double y0,double wd,double ht)
{
   ...
   Color focuscolor = bcon_props.getColor(BCON_FOCUS_COLOR,Color.RED);
   Color existscolor = bcon_props.getColor(BCON_EXISTS_COLOR,Color.YELLOW);
   Color notexistscolor = bcon_props.getColor(BCON_NOTEXISTS_COLOR,NOTEXISTS_COLOR);
   Color codecolor = bcon_props.getColor(BCON_CODE_COLOR,CODE_COLOR);
   Color cmmtcolor = bcon_props.getColor(BCON_COMMENT_COLOR,COMMENT_COLOR);
