        ...
        throws NobaseException
{
   ...
   if (plc != null) {
      if (proj != null) plc.setAttribute(NobaseConfigAttribute.PROJECT,proj);
        ...
        throws NobaseException
{
   ...
   else if (prop.equals(NobaseConfigAttribute.FILE)) {
...
void editBreakpoint(String id,String p1,String v1,String p2,String v2,
      String p3,String v3) 
        throws NobaseException
{
   ...
   bp.setProperty(p1,v1);
   bp.setProperty(p2,v2);
   bp.setProperty(p3,v3);
   removeBreakpoint(bp);
   addBreakpoint(bp);
...
private void loadBreakpoints()
{
   ...
   if (xml == null) {
	 ...
	 try {
	    NobaseDebugBreakpoint pb = NobaseDebugBreakpoint.createBreakpoint(xml);
            if (pb == null) continue;
            switch (pb.getType()) {
               case NONE : 
                  break;
        ...
        throws NobaseException
{
   ...
   switch (action) {
      ...
      case STEP_RETURN :
         ...
         break;
      case DROP_TO_FRAME :
         if (tgt.canDropToFrame()) tgt.dropToFrame();
         else ok = false;
         break;
    }
...
void evaluateExpression(String proj,String bid,String expr,
      String frame,boolean implicit,boolean stop,String rid,
      IvyXmlWriter xw)
{
