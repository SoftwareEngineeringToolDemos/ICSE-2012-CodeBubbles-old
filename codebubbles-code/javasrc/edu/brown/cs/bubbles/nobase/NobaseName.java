...
class NobaseName implements NobaseConstants, NobaseAst
{
...
private NobaseAstNode   def_node;
...
NobaseName(NobaseProject p,NobaseFile ifd,NobaseAstNode n,String nm,NameType typ)
{
   for_project = p;
   for_file = ifd;
   def_node = n;
...
NobaseAstNode getAstNode()              { return def_node; }
